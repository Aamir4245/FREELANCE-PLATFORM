            ...
            <div class="row m-0 regstr-con-row">
                ...
                <div class="col-xxl-12 col-lg-12 col-md-12 regstr-con-row-col p-0">
                    ...
                    <div class="regstr-con-card p-0">
                        ...
                        <div
                            class="sticky-top d-flex justify-content-between align-items-center px-4 py-2 mb-4 register-top-bar">
                        ...
                        <form id="registrationForm" method="POST">
                            ...
                            <div class="row register-form-inline-field-row m-0">
                                ...
                                <span
                                    class="register-form-inline-field-row-title translate-middle rounded-pill w-auto top-0">
                                    Personal Details
                                </span>
                                ...
                                <div class="col-xxl-5 form-group">
                                    ...
                                    <div class="form-group" name="user">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="userType" id="freelancer"
                                                value="Freelancer">
                                            <label class="form-check-label form-field-title"
                                                for="freelancer">Freelancer</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="userType" id="client"
                                                value="Client">
                                ...
                                <div class="hidden my-3 row freelancerFields">
                                    <div class="form-group col-xxl-4">
                                        ...
                                        <input type="text" class="form-control" id="lastName" name="lastName"
                                            placeholder="Last Name" minlength="3" maxlength="30">
                                    </div>
                                    <div class="form-group col-xxl-4">
                                    ...
                                    <div class="form-group col-xxl-4">
                                        <label for="countryFreelancer"
                                            class="form-field-title  py-1 px-1">Country</label>
                                        <input type="text" class="form-control" id="countryFreelancer"
                                            name="countryFreelancer" placeholder="Country" maxlength="25">
                                    </div>
                                </div>
                            ...
                            <div class="row register-form-inline-field-row m-0 mt-5 hidden freelancerFields">
                                ...
                                <div class="form-group col-xxl-4">
                                    ...
                                    <input type="text" class="form-control" id="field" name="field"
                                        placeholder="Web Development" maxlength="30">
                                </div>

                                <!-- ++++++++++++++++++++++++++++ Register Fluid >>>>> Form > Education + Certification > PL 1 ++++++++++++++++++++++++++++ -->

                                <div class="form-group col-xxl-4">
                                    <label for="fieldLang1" class="form-field-title  py-1 px-1">Programming Language
                                        1</label>
                                    <input type="text" class="form-control" id="fieldLang1" name="fieldLang1"
                                        placeholder="Python" maxlength="15">
                                </div>

                                <!-- ++++++++++++++++++++++++++++ Register Fluid >>>>> Form > Education + Certification > PL 2 ++++++++++++++++++++++++++++ -->

                                <div class="form-group col-xxl-4">
                                    <label for="fieldLang2" class="form-field-title  py-1 px-1">Programming Language
                                        2</label>
                                    <input type="text" class="form-control" id="fieldLang2" name="fieldLang2"
                                        placeholder="C++" maxlength="15">
                                </div>

                                <!-- ++++++++++++++++++++++++++++ Register Fluid >>>>> Form > Education + Certification > PL 3 - Not Mendetory ++++++++++++++++++++++++++++ -->

                                <div class="form-group col-xxl-4">
                                    <label for="fieldLang3" class="form-field-title  py-1 px-1">Programming Language
                                        3</label>
                                    <input type="text" class="form-control" id="fieldLang3" name="fieldLang3"
                                        placeholder="Rust" maxlength="15">
                                </div>

                                <!-- ++++++++++++++++++++++++++++ Register Fluid >>>>> Form > Education + Certification > Technology Specification ++++++++++++++++++++++++++++ -->

                                <div class="form-group col-xxl-4">
                                    <label for="technology" class="form-field-title  py-1 px-1">Technology
                                        Specification</label>
                                    <input type="text" class="form-control" id="technology" name="technology"
                                        placeholder="Blockchain" maxlength="30">
                                </div>

                                <!-- ++++++++++++++++++++++++++++ Register Fluid >>>>> Form > Education + Certification > Degree / Certification ++++++++++++++++++++++++++++ -->

                                <div class="form-group col-xxl-4">
                                    <label for="degree" class="form-field-title  py-1 px-1">Degree /
                                        Certification</label>
                                    <input type="text" class="form-control" id="degree" name="degree"
                                        placeholder="Degree / Certification" maxlength="30">
                                </div>
                            ...
                            <div class="row register-form-inline-field-row m-0 mt-5 hidden freelancerFields">
                                ...
                                <div class="form-group col-xxl-8">
                                    <label for="experience" class="form-field-title  py-1 px-1">Experience /
                                        Internship</label>
                                    <input type="text" class="form-control" id="experience" name="experience"
                                        placeholder="1 Year , FrelaxPro PVT. LTD" maxlength="50">
                                </div>
                                    ...
                                    <div class="form-group col-xxl-5 position-relative" name="pass-group">
                                        ...
                                        <div class="passiconwrap">
                                            <input type="password" class="form-control" id="password" name="password"
                                                placeholder="Password" maxlength="18" autocomplete="true">
                            ...
                            <div class="form-check mt-3">
                                <input type="checkbox" class="form-check-input" id="termscon"
                                    onchange="toggleSubmitButton()">
                                <label class="form-check-label form-field-title py-0" for="termscon">I'm Agree Terms &
                                    Conditions</label>
                            </div>
                        ...
                        <p class="text-center mt-3">Already have an account ?
                            <br>
                            <a href="./Login.php" class="login-in-link">Login</a>
                        </p>
